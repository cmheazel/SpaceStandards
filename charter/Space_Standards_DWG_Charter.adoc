...
There is no common concept of “Space Standards”. The Space Domain is composed of a wide collection of initiatives, each addressing one part of the whole. Each of these initiatives develops their own standards and conventions. Attempts to harmonize across these initiatives is limited.
...
.. Facilites development and management on non-terrestial planets
.. Facilites development and management in Space.
...
.. Space debry management
. Identify the information and computational capabilites needed to execute each mission.
